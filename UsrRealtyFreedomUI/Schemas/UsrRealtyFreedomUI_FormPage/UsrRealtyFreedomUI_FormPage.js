	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_8oxqb1w_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "MenuItem_so1g2bm",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_so1g2bm_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				var typeObject = await request.$context.PDS_UsrType_uvfzw01;
				var typeId = "";
				if (typeObject) {
				...
				// get id from type lookup type object
				var offerTypeObject = await request.$context.PDS_UsrOffertype_fn2nf43;
				var offerTypeId = "";
				if (offerTypeObject) {
